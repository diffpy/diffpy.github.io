...
- **PDFgui** user manual formatted as `HTML <doc/pdfgui/pdfgui.html>`__,
  `PDF <doc/pdfgui/pdfgui.pdf>`__,
  tutorial files in a `zip archive <doc/pdfgui/pdfgui-tutorial.zip>`__
