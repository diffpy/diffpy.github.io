# 2007-12-04 PJ: nastily hacked publisher.py, which did not want work
# well with htdigest authentication.  This handler should be replaced
# with "AddHandler mod_python .py" in diffpy.conf as soon as diffpy.org
# moves to server with recent mod_python.
# YUCK.
...
import mod_python.util as util
